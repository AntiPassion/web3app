...
create table t_statistics(
  ...
  uid int comment '用户id',
  username varchar(100) comment '用户名',
  today_amount decimal(20,2) comment '当日剩余总额',
  profit_amount decimal(20,2) comment '当日盈利总额',
  bet_amount decimal(20,2) comment '投注总额',
  recharge_trc20_amount decimal(20,2) comment '充值trc20总额',
  recharge_trx_amount decimal(20,2) comment '充值trx总额',
  withdraw_trc20_amount decimal(20,2) comment '提现trc20总额',
  withdraw_trx_amount decimal(20,2) comment '提现trx总额',
  update_time timestamp null default null comment '更新时间',
